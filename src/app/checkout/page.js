...
// useEffect(() => {
//   if (user) {
//     // Combine address, city, zipCode, country into a single address field
//     const addressParts = [];
...
//     setFormData(prev => ({
//       ...prev,
//       // Personal Info - These will be non-editable for logged-in users
...
//       // Keep individual fields for reference (if needed elsewhere)
//       city: user.city || '',
//       zipCode: user.zipCode || '',
//       country: user.country || 'Bangladesh',
//     }));
    
//     // Set location dropdown values if city exists (for shipping calculation)
//     if (user.city) {
...
//         body: JSON.stringify({ code: couponCode, subtotal: cart?.subtotal || 0 })
//       });
