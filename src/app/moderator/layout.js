...
export default function ModeratorLayout({ children }) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/moderator/dashboard', icon: LayoutDashboard, color: '#4A8A90' },
    { name: 'Create Categories', href: '/moderator/create-categories', icon: FolderPlus, color: '#4A8A90' },
    ...
    { name: 'Manage Blogs', href: '/moderator/manage-blogs', icon: Edit, color: '#4A8A90' },
    { name: 'Manage Certifications', href: '/moderator/certifications', icon: Award, color: '#4A8A90' },
    { name: 'Manage Reviews', href: '/moderator/manage-reviews', icon: Star, color: '#4A8A90' },
    { name: 'Settings', href: '/moderator/settings', icon: Settings, color: '#4A8A90' }
  ];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#4A8A90]/10 via-[#FFB6C1]/10 to-[#D4EDEE]/20">
        <div className="text-center">
          ...
          <p className="text-[#4A8A90] font-comic mt-3">Loading Moderator Dashboard...</p>
        </div>
      </div>
    );
  }
